...
public class ClubAnnRegisterController {
    ...
    // TODO: 2017/9/2
    /**
     * 社团管理端提交年度注册信息，该功能还没有完成
     * 审核文件放在D://masterspring//MySAUImages//clubRegister
     * <p>
     * 结果的map集合
     *
     * @param session 会话
    ...
    public Map<String, Object> submitRegisterMsg(HttpSession session,HttpServletRequest request) {
        BaseReturnData returnData = new BaseReturnData();
        //上传文件
        uploadFile(request,"upload");
/*    out.println(annRegisterMap);

    //如果接受到审核结果为空
    if (annRegisterMap == null) {
